...
Nous commencerons tout d'abord par définir ce qu'est un signal,
...
Une aide sur l'installation de Python et son utilisation est disponible sur la page @P:python.
