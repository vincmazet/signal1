...
````{tab-item} Son
Le son original, échantillonné à 44 100 Hz, est sous-échantillonné à l'une des trois fréquences ci-dessous.

Son original ($f_e=$ 44 100 Hz) :
<audio controls src="Elise.wav"><a href="Elise.wav">Écouter</a></audio>

Son rééchantillonné à $f_e=$ 4410 Hz :
<audio controls src="Elise-4410.wav"><a href="Elise-4410.wav">Écouter</a></audio>

Son rééchantillonné à $f_e=$ 2205 Hz :
<audio controls src="Elise-2205.wav"><a href="Elise-2205.wav">Écouter</a></audio>

Son rééchantillonné à $f_e=$ 1470 Hz :
<audio controls src="Elise-1470.wav"><a href="Elise-1470.wav">Écouter</a></audio>

Notez que pour que le haut-parleur puisse l'émettre convenablement,
le signal sous-échantillonné est rééchantillonné à 44 100 Hz,
mais ce rééchantillonnage ne remplace pas les fréquences repliées à cause du sous-échantillonnage !
